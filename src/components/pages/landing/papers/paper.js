        ...
        <>
            <div className="card card-compact w-96 bg-base-300 shadow-xl bg-white text-black">
                ...
                <div className="flex flex-wrap mx-2 mt-4 gap-2 justify-items-center w-full">
                    {proj.tags.map((tag) => {
                        return <div className="badge whitespace-nowrap badge-outline">{tag}</div>;
                    })}
                </div>
                    ...
                    <div className="card-actions justify-end" style={{ marginTop: 1 + 'em' }}>
                        {proj.paperPage.length > 0 ? (
                            <button className="btn btn-primary bg-themeOrange border-none text-white">
                                {' '}
                                <Link to={proj.projectPage} target="_blank" rel="noopener noreferrer">
                                    Project Page
                                </Link>{' '}
                            </button>
                        ) : (
                        ...
                        {proj.github.length > 0 ? (
                            <button className="btn btn-primary bg-themeOrange border-none text-white">
                                {' '}
                                <Link to={proj.github} target="_blank" rel="noopener noreferrer">
                                    Github
                                </Link>{' '}
                            </button>
                        ) : (
